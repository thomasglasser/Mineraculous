...
/// Fades and rises slightly over time
public class FadingParticle extends TextureSheetParticle {
    public FadingParticle(ClientLevel level, double x, double y, double z) {
        super(level, x, y, z);
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            FadingParticle particle = new FadingParticle(level, x, y, z);
