...
public class MineraculousEntityDataSerializers {
    ...
    public static final DeferredHolder<EntityDataSerializer<?>, EntityDataSerializer<Optional<Holder<ToolMode>>>> OPTIONAL_TOOL_MODE = ENTITY_DATA_SERIALIZERS.register("optional_tool_mode", () -> EntityDataSerializer.forValueType(ByteBufCodecs.optional(ToolMode.STREAM_CODEC)));
