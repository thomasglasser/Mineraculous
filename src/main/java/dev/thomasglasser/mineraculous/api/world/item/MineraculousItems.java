...
public class MineraculousItems {
    ...
    public static final DeferredItem<RabbitUmbrellaItem> RABBIT_UMBRELLA = register("rabbit_umbrella", () -> new RabbitUmbrellaItem(MIRACULOUS_TOOL_PROPERTIES_WITH_ACTIVE.apply(new Item.Properties()).component(MineraculousDataComponents.ACTIVE_SETTINGS, CatStaffItem.ACTIVE_SETTINGS)));
