...
public class TransmuteSmeltingRecipe extends SmeltingRecipe {
    ...
    public TransmuteSmeltingRecipe(String group, CookingBookCategory category, Ingredient ingredient, ItemLike result, float experience, int cookingTime) {
    ...
    public RecipeSerializer<?> getSerializer() {
        return MineraculousRecipeSerializers.SMELTING_TRANSMUTE.get();
    }
}
