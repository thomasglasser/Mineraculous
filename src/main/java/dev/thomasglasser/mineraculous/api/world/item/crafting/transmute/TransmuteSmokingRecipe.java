...
public class TransmuteSmokingRecipe extends SmokingRecipe {
    ...
    public TransmuteSmokingRecipe(String group, CookingBookCategory category, Ingredient ingredient, ItemLike result, float experience, int cookingTime) {
    ...
    public RecipeSerializer<?> getSerializer() {
        return MineraculousRecipeSerializers.SMOKING_TRANSMUTE.get();
    }
}
