...
public class MineraculousRenderTypes {
    ...
    private static final RenderType ITEM_LUCKY_CHARM = createLuckyCharm("item", LUCKY_CHARM_TEXTURE.apply("item"), MineraculousRenderStateShards.ITEM_LUCKY_CHARM_TEXTURING, false);
    ...
    private static RenderType createLuckyCharm(String name, ResourceLocation texture, RenderStateShard.TexturingStateShard texturingStateShard, boolean offsetZLayering) {
        return RenderType.create(
                Mineraculous.modLoc(name + "_lucky_charm").toString(),
