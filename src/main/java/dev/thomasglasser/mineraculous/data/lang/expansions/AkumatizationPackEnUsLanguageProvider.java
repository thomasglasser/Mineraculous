...
public class AkumatizationPackEnUsLanguageProvider extends ExtendedEnUsLanguageProvider {
    ...
    protected void addTranslations() {
        ...
        addPage("wiki", "apis", "kamikotizations", "generator", "text", "A generator for akumatizations can be found online [here](https://snapshot-jsons.thomasglasser.dev/mineraculous/kamikotization/).\n");
