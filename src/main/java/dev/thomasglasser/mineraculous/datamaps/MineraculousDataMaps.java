...
public class MineraculousDataMaps {
    ...
    // Mob Effects
    public static final DataMapType<MobEffect, Integer> MIRACULOUS_EFFECTS = DataMapType.builder(Mineraculous.modLoc("miraculous_effects"), Registries.MOB_EFFECT, Codec.INT).build();
}
