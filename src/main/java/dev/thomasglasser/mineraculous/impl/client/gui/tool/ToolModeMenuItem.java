...
public class ToolModeMenuItem<T> implements SelectionMenuItem {
    ...
    protected final MiraculousTool.ToolMode toolMode;

    public ToolModeMenuItem(MiraculousTool.ToolMode mode) {
        name = mode.displayName();
        iconTexture = mode.getIcon();
        toolMode = mode;
    }

    public static List<SelectionMenuItem> getToolModeMenuItems(List<MiraculousTool.ToolMode> modes) {
        return modes.stream()
    ...
    public MiraculousTool.ToolMode getToolMode() {
        return toolMode;
    }
