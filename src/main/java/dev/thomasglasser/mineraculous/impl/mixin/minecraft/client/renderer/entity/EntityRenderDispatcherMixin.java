...
public class EntityRenderDispatcherMixin {
    ...
    private <T extends Entity> EntityRenderer<? super T> getRenderer(EntityRenderer<? super T> original, T entity) {
        if (original == null && entity instanceof LivingEntity && entity instanceof PlayerLike playerLike)
            return (EntityRenderer<? super T>) PlayerLikeRenderer.get(playerLike.getSkin().model());
        return original;
    }
}
