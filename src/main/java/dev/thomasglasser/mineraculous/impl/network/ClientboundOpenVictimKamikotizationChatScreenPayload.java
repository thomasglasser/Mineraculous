...
public record ClientboundOpenVictimKamikotizationChatScreenPayload(UUID performer, KamikotizationData kamikotizationData, SlotInfo slotInfo) implements ExtendedPacketPayload {
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, ClientboundOpenVictimKamikotizationChatScreenPayload> CODEC = StreamCodec.composite(
            ...
            SlotInfo.STREAM_CODEC, ClientboundOpenVictimKamikotizationChatScreenPayload::slotInfo,
