...
public class MineraculousPayloads {
    public static List<PayloadInfo<?>> PAYLOADS = ImmutableList.of(
            // Serverbound
            new PayloadInfo<>(ServerboundCancelCatStaffPerchPayload.TYPE, ExtendedPacketPayload.Direction.CLIENT_TO_SERVER, ServerboundCancelCatStaffPerchPayload.CODEC),
