...
public record ServerboundCloseKamikotizationChatScreenPayload(UUID playerId, boolean cancel) implements ExtendedPacketPayload {
    public static final Type<ServerboundCloseKamikotizationChatScreenPayload> TYPE = new Type<>(MineraculousConstants.modLoc("serverbound_close_kamikotization_chat_screen"));
