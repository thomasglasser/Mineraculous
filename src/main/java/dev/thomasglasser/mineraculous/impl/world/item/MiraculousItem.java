    ...
    public void inventoryTick(ItemStack stack, Level level, Entity entity, int slotId, boolean isSelected) {
        ...
        if (level instanceof ServerLevel serverLevel) {
            ...
            if (entity instanceof LivingEntity livingEntity && !CuriosUtils.isEquipped(livingEntity, stack)) {
                stack.set(MineraculousDataComponents.POWER_STATE, stack.has(MineraculousDataComponents.POWERED) ? AbstractMiraculousItem.PowerState.POWERED : AbstractMiraculousItem.PowerState.ACTIVE);
            }
        }
    }
