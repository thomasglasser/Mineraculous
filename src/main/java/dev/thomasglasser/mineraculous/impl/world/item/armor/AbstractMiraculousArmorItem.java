...
public class AbstractMiraculousArmorItem extends ArmorItem implements GeoArmorItem {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    public AbstractMiraculousArmorItem(Holder<ArmorMaterial> material, Type type, Properties properties) {
