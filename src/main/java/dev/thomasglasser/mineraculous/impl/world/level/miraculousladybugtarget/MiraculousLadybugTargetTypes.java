...
public class MiraculousLadybugTargetTypes {
    ...
    public static final DeferredHolder<MiraculousLadybugTargetType<?>, MiraculousLadybugTargetType<MiraculousLadybugClusterTarget>> CLUSTER = register("cluster", MiraculousLadybugClusterTarget.MAP_CODEC, MiraculousLadybugClusterTarget.STREAM_CODEC);
