package dev.thomasglasser.mineraculous.mixin.tommylib.api.client.renderer.entity;
...
public class ThrownSwordRendererMixin {
    ...
    private VertexConsumer render(VertexConsumer original, @Local(argsOnly = true) MultiBufferSource bufferSource, @Local(argsOnly = true) ThrownSword sword) {
        return /*MineraculousClientUtils.checkLuckyCharm(original, bufferSource, sword.getPickupItemStackOrigin())*/original;
    }
}
