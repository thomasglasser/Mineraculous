...
public record ClientboundOpenPerformerKamikotizationChatScreenPayload(String performerName, String targetName, UUID targetId) implements ExtendedPacketPayload {
    ...
    public void handle(Player player) {
        MineraculousClientUtils.openPerformerKamikotizationChatScreen(performerName, targetName, player.level().getPlayerByUUID(targetId));
    }
