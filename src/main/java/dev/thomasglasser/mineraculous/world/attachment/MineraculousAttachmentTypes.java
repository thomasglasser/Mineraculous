...
public class MineraculousAttachmentTypes {
    ...
    public static final DeferredHolder<AttachmentType<?>, AttachmentType<Optional<UUID>>> LADYBUG_YOYO = ATTACHMENT_TYPES.register("ladybug_yoyo", () -> AttachmentType.builder(Optional::<UUID>empty).serialize(UUIDUtil.CODEC.optionalFieldOf("uuid").codec()).build());
