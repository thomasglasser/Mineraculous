...
public class MineraculousAttachmentTypes {
    ...
    public static final DeferredHolder<AttachmentType<?>, AttachmentType<HashBasedTable<ResourceKey<Miraculous>, String, LookData>>> MIRACULOUS_LOOKS = ATTACHMENT_TYPES.register("miraculous_looks", () -> AttachmentType.builder(() -> HashBasedTable.<ResourceKey<Miraculous>, String, LookData>create()).build());
