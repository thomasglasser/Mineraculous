...
public record Miraculous(TextColor color, String acceptableSlot, ItemStack tool, Optional<Holder<SoundEvent>> kwamiHungrySound, Optional<Holder<Ability>> activeAbility, List<Holder<Ability>> passiveAbilities, Holder<SoundEvent> transformSound, Holder<SoundEvent> detransformSound) {
    ...
    public Miraculous(TextColor color, String acceptableSlot, ItemStack tool, Optional<Holder<SoundEvent>> kwamiHungrySound, Optional<Holder<Ability>> activeAbility, List<Holder<Ability>> passiveAbilities, Holder<SoundEvent> transformSound) {
        this(color, acceptableSlot, tool, kwamiHungrySound, activeAbility, passiveAbilities, transformSound, MineraculousSoundEvents.GENERIC_DETRANSFORM);
    }
    ...
    public Miraculous(TextColor color, String acceptableSlot, ItemStack tool, Optional<Holder<SoundEvent>> kwamiHungrySound, Optional<Holder<Ability>> activeAbility, List<Holder<Ability>> passiveAbilities) {
        this(color, acceptableSlot, tool, kwamiHungrySound, activeAbility, passiveAbilities, MineraculousSoundEvents.GENERIC_TRANSFORM, MineraculousSoundEvents.GENERIC_DETRANSFORM);
    }
