...
public record ReplaceItemsInHandAbility(ItemStack replacement, Optional<ItemPredicate> validItems, Optional<ItemPredicate> invalidItems, Optional<Holder<SoundEvent>> startSound) implements Ability {
