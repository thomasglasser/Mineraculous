...
public class KamikotizationArmorItem extends ExtendedArmorItem implements GeoArmorItem, ModeledItem {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    public KamikotizationArmorItem(ArmorType type, Properties pProperties) {
