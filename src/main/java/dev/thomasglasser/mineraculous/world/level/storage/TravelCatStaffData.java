...
import dev.thomasglasser.mineraculous.network.ClientboundCatStaffTravelPayload;
...
public record TravelCatStaffData(float length, BlockPos blockPos, boolean traveling, Vector3f initialLookingAngle, float y, float initBodAngle, boolean launch) {
    ...
    public static final StreamCodec<ByteBuf, TravelCatStaffData> STREAM_CODEC = NetworkUtils.composite(
