...
public class MineraculousLootItemConditions {
    ...
    public static final DeferredHolder<LootItemConditionType, LootItemConditionType> HAS_AMMO = register("has_ammo", HasAmmoCheck.CODEC);
    public static final DeferredHolder<LootItemConditionType, LootItemConditionType> SHOOTER_MATCHES = register("shooter_matches", MatchShooter.CODEC);
